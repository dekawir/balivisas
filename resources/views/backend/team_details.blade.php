        ...
        <div class="col-md-4">
            ...
            <div>
                ...
                <div class="ibox-content no-padding border-left-right">
                    <img alt="image" class="img-fluid" src="{{asset('team/'.$a->path)}}" width="300px">
                </div>
               
                <div class="ibox-content profile-content">
                    <h4><strong>{{$a->name}}</strong></h4>
                    <p><i class="fa fa-map-marker"></i> Balivisas</p>
                    <div class="row m-t-lg">
                        <div class="col-md-4">
                            <span class="bar">Created By</span>
                            <h5><strong>{{$a->uname}}</strong> </h5>
                        </div>
                        <div class="col-md-4">
                            ...
                            <div class="feed-element">
                                ...
                                <form action="{{route('update.team')}}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row"><label class="col-lg-2 col-form-label">Title</label>
                                        <div class="col-lg-10"><input type="text" placeholder="Name" name="name" class="form-control" value="{{$a->name}}">
                                        </div>
                                    </div>
                                    <div class="form-group row"><label class="col-lg-2 col-form-label">Position</label>
                                        <div class="col-lg-10"><input type="text" placeholder="Position" name="position" class="form-control" value="{{$a->position}}">
                                        </div>
                                    </div>
                                    <div class="form-group row"><label class="col-lg-2 col-form-label">Whatsapp</label>
                                        <div class="col-lg-10"><input type="text" placeholder="Whatsapp" name="whatsapp" class="form-control" value="{{$a->whatsapp}}">
                                        </div>
                                    </div>
                                    <div class="form-group row"><label class="col-lg-2 col-form-label">Email</label>
                                        <div class="col-lg-10"><input type="text" placeholder="Email" name="email" class="form-control" value="{{$a->email}}">
                                        </div>
                                    </div>
